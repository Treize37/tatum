# SwaggerClient::TransferBchKeyPair
...
**key_pair** | [**Array&lt;TransferBchKeyPairKeyPair&gt;**](TransferBchKeyPairKeyPair.md) | Array of assigned blockchain addresses with their private keys. Either mnemonic, keyPair or signature Id must be present - depends on the type of account and xpub. Tatum KMS does not support keyPair type of off-chain transaction, only mnemonic based.  | 
