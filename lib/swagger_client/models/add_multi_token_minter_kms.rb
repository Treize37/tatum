  ...
  class AddMultiTokenMinterKMS
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AddMultiTokenMinterKMS` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AddMultiTokenMinterKMS`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'minter')
        self.minter = attributes[:'minter']
      end
    ...
    def list_invalid_properties
      ...
      if @minter.nil?
        invalid_properties.push('invalid value for "minter", minter cannot be nil.')
      end
    ...
    def valid?
      ...
      chain_validator = EnumAttributeValidator.new('Object', ['ETH', 'MATIC', 'KCS', 'CELO', 'ONE', 'BSC'])
      return false unless chain_validator.valid?(@chain)
      return false if @contract_address.nil?
      return false if @minter.nil?
    ...
    def chain=(chain)
      validator = EnumAttributeValidator.new('Object', ['ETH', 'MATIC', 'KCS', 'CELO', 'ONE', 'BSC'])
    ...
    def hash
      [chain, contract_address, minter, index, signature_id, nonce, fee, fee_currency].hash
    end
