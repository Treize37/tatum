  ...
  class ChartRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ChartRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ChartRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      time_frame_validator = EnumAttributeValidator.new('Object', ['MIN_1', 'MIN_3', 'MIN_5', 'MIN_15', 'MIN_30', 'HOUR_1', 'HOUR_4', 'HOUR_12', 'DAY', 'WEEK', 'MONTH', 'YEAR'])
    ...
    def time_frame=(time_frame)
      validator = EnumAttributeValidator.new('Object', ['MIN_1', 'MIN_3', 'MIN_5', 'MIN_15', 'MIN_30', 'HOUR_1', 'HOUR_4', 'HOUR_12', 'DAY', 'WEEK', 'MONTH', 'YEAR'])
