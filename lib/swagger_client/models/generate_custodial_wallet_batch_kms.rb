...
module SwaggerClient
  class GenerateCustodialWalletBatchKMS
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::GenerateCustodialWalletBatchKMS` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::GenerateCustodialWalletBatchKMS`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @batch_count.nil?
        invalid_properties.push('invalid value for "batch_count", batch_count cannot be nil.')
      end
    ...
    def valid?
      ...
      chain_validator = EnumAttributeValidator.new('Object', ['MATIC', 'ETH', 'ONE', 'XDC', 'BSC'])
      return false unless chain_validator.valid?(@chain)
      return false if @signature_id.nil?
      return false if @batch_count.nil?
    ...
    def chain=(chain)
      validator = EnumAttributeValidator.new('Object', ['MATIC', 'ETH', 'ONE', 'XDC', 'BSC'])
    ...
    def hash
      [chain, signature_id, index, batch_count, owner, fee, nonce].hash
    end
