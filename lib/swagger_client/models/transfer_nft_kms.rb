...
module SwaggerClient
  class TransferNftKMS
    ...
    attr_accessor :provenance_data

    # current price of the token, valid only for provenance
    attr_accessor :token_price
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::TransferNftKMS` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::TransferNftKMS`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'provenance_data')
        self.provenance_data = attributes[:'provenance_data']
      end

      if attributes.key?(:'token_price')
        self.token_price = attributes[:'token_price']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          provenance_data == o.provenance_data &&
    ...
    def hash
      [value, chain, to, token_id, contract_address, index, provenance, provenance_data, token_price, signature_id, nonce, fee].hash
    end
