...
module SwaggerClient
  class UpdateCashbackValueForAuthorNftKMS
    # Chain to work with.
    attr_accessor :chain
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UpdateCashbackValueForAuthorNftKMS` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UpdateCashbackValueForAuthorNftKMS`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cashback_value')
        self.cashback_value = attributes[:'cashback_value']
      end
    ...
    def list_invalid_properties
      ...
      if @cashback_value.nil?
        invalid_properties.push('invalid value for "cashback_value", cashback_value cannot be nil.')
      end
    ...
    def valid?
      ...
      chain_validator = EnumAttributeValidator.new('Object', ['ETH', 'MATIC', 'KCS', 'ONE', 'BSC'])
      return false unless chain_validator.valid?(@chain)
      return false if @token_id.nil?
      return false if @cashback_value.nil?
    ...
    def chain=(chain)
      validator = EnumAttributeValidator.new('Object', ['ETH', 'MATIC', 'KCS', 'ONE', 'BSC'])
    ...
    def hash
      [chain, token_id, cashback_value, contract_address, index, signature_id, nonce, fee].hash
    end
