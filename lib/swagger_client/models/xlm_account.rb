  ...
  class XlmAccount
    ...
    def self.openapi_types
      {
        ...
        :'account_id' => :'Object',
        :'sequence' => :'Object',
        :'subentry_count' => :'Object',
        :'last_modified_ledger' => :'Object',
        :'thresholds' => :'Object',
        :'flags' => :'Object',
        :'balances' => :'Object',
        :'signers' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::XlmAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::XlmAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subentry_count')
        self.subentry_count = attributes[:'subentry_count']
      end

      if attributes.key?(:'last_modified_ledger')
        self.last_modified_ledger = attributes[:'last_modified_ledger']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sequence == o.sequence &&
          subentry_count == o.subentry_count &&
    ...
    def hash
      [id, account_id, sequence, subentry_count, last_modified_ledger, thresholds, flags, balances, signers, data].hash
    end
