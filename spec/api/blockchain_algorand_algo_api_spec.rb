...
# Unit tests for SwaggerClient::BlockchainAlgorandALGOApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainAlgorandALGOApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainAlgorandALGOApi.new
  end
  ...
  describe 'test an instance of BlockchainAlgorandALGOApi' do
    it 'should create an instance of BlockchainAlgorandALGOApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainAlgorandALGOApi)
    end
  end
