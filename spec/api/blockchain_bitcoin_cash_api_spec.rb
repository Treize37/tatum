...
# Unit tests for Tatum::BlockchainBitcoinCashApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainBitcoinCashApi' do
  before do
    # run before each test
    @instance = Tatum::BlockchainBitcoinCashApi.new
  end
  ...
  describe 'test an instance of BlockchainBitcoinCashApi' do
    it 'should create an instance of BlockchainBitcoinCashApi' do
      expect(@instance).to be_instance_of(Tatum::BlockchainBitcoinCashApi)
    end
  end
