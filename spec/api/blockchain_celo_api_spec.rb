...
# Unit tests for SwaggerClient::BlockchainCeloApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainCeloApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainCeloApi.new
  end
  ...
  describe 'test an instance of BlockchainCeloApi' do
    it 'should create an instance of BlockchainCeloApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainCeloApi)
    end
  end
