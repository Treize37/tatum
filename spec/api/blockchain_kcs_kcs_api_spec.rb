...
# Unit tests for SwaggerClient::BlockchainKcsKCSApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainKcsKCSApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainKcsKCSApi.new
  end
  ...
  describe 'test an instance of BlockchainKcsKCSApi' do
    it 'should create an instance of BlockchainKcsKCSApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainKcsKCSApi)
    end
  end

  # unit tests for kcs_blockchain_smart_contract_invocation
  ...
  describe 'kcs_blockchain_smart_contract_invocation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_blockchain_transfer
  ...
  describe 'kcs_blockchain_transfer test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_broadcast
  ...
  describe 'kcs_broadcast test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_estimate_gas
  ...
  describe 'kcs_estimate_gas test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_generate_address
  ...
  describe 'kcs_generate_address test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_generate_address_private_key
  ...
  # @param [Hash] opts the optional parameters
  # @return [PrivKey]
  describe 'kcs_generate_address_private_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_generate_wallet
  # Generate Kcs wallet
  ...
  # @return [Wallet]
  describe 'kcs_generate_wallet test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_get_balance
  ...
  describe 'kcs_get_balance test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_get_block
  ...
  # @param [Hash] opts the optional parameters
  # @return [EthBlock]
  describe 'kcs_get_block test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_get_current_block
  ...
  # @param [Hash] opts the optional parameters
  # @return [BigDecimal]
  describe 'kcs_get_current_block test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_get_transaction
  # Get Kcs Transaction
  # &lt;h4&gt;2 credit per API call.&lt;/h4&gt;&lt;br/&gt;&lt;p&gt;Get Kcs transaction by transaction hash.&lt;/p&gt;
  # @param hash Transaction hash
  # @param [Hash] opts the optional parameters
  # @return [KcsTx]
  describe 'kcs_get_transaction test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_get_transaction_count
  ...
  # @param [Hash] opts the optional parameters
  # @return [BigDecimal]
  describe 'kcs_get_transaction_count test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for kcs_web3_driver
  # Web3 HTTP driver
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'kcs_web3_driver test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
