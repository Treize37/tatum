...
# Unit tests for Tatum::BlockchainMarketplaceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainMarketplaceApi' do
  before do
    # run before each test
    @instance = Tatum::BlockchainMarketplaceApi.new
  end
  ...
  describe 'test an instance of BlockchainMarketplaceApi' do
    it 'should create an instance of BlockchainMarketplaceApi' do
      expect(@instance).to be_instance_of(Tatum::BlockchainMarketplaceApi)
    end
  end
