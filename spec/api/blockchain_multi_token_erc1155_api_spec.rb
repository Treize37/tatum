...
# Unit tests for SwaggerClient::BlockchainMultiTokenERC1155Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainMultiTokenERC1155Api' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainMultiTokenERC1155Api.new
  end
  ...
  describe 'test an instance of BlockchainMultiTokenERC1155Api' do
    it 'should create an instance of BlockchainMultiTokenERC1155Api' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainMultiTokenERC1155Api)
    end
  end
