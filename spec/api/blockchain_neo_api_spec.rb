...
# Unit tests for SwaggerClient::BlockchainNEOApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainNEOApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainNEOApi.new
  end
  ...
  describe 'test an instance of BlockchainNEOApi' do
    it 'should create an instance of BlockchainNEOApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainNEOApi)
    end
  end
