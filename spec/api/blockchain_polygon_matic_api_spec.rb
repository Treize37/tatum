...
# Unit tests for Tatum::BlockchainPolygonMaticApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainPolygonMaticApi' do
  before do
    # run before each test
    @instance = Tatum::BlockchainPolygonMaticApi.new
  end
  ...
  describe 'test an instance of BlockchainPolygonMaticApi' do
    it 'should create an instance of BlockchainPolygonMaticApi' do
      expect(@instance).to be_instance_of(Tatum::BlockchainPolygonMaticApi)
    end
  end
