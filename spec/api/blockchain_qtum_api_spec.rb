...
# Unit tests for SwaggerClient::BlockchainQTUMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainQTUMApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainQTUMApi.new
  end
  ...
  describe 'test an instance of BlockchainQTUMApi' do
    it 'should create an instance of BlockchainQTUMApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainQTUMApi)
    end
  end
