...
# Unit tests for SwaggerClient::BlockchainQuorumApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainQuorumApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainQuorumApi.new
  end
  ...
  describe 'test an instance of BlockchainQuorumApi' do
    it 'should create an instance of BlockchainQuorumApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainQuorumApi)
    end
  end
