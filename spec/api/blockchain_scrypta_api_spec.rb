...
# Unit tests for SwaggerClient::BlockchainScryptaApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainScryptaApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainScryptaApi.new
  end
  ...
  describe 'test an instance of BlockchainScryptaApi' do
    it 'should create an instance of BlockchainScryptaApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainScryptaApi)
    end
  end
