...
# Unit tests for SwaggerClient::BlockchainTronApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainTronApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainTronApi.new
  end
  ...
  describe 'test an instance of BlockchainTronApi' do
    it 'should create an instance of BlockchainTronApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainTronApi)
    end
  end
