...
# Unit tests for SwaggerClient::BlockchainVeChainApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainVeChainApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainVeChainApi.new
  end
  ...
  describe 'test an instance of BlockchainVeChainApi' do
    it 'should create an instance of BlockchainVeChainApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainVeChainApi)
    end
  end
