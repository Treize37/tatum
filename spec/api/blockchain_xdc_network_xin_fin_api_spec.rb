...
# Unit tests for Tatum::BlockchainXDCNetworkXinFinApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainXDCNetworkXinFinApi' do
  before do
    # run before each test
    @instance = Tatum::BlockchainXDCNetworkXinFinApi.new
  end
  ...
  describe 'test an instance of BlockchainXDCNetworkXinFinApi' do
    it 'should create an instance of BlockchainXDCNetworkXinFinApi' do
      expect(@instance).to be_instance_of(Tatum::BlockchainXDCNetworkXinFinApi)
    end
  end
