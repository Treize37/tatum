...
# Unit tests for SwaggerClient::BlockchainXLMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainXLMApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainXLMApi.new
  end
  ...
  describe 'test an instance of BlockchainXLMApi' do
    it 'should create an instance of BlockchainXLMApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainXLMApi)
    end
  end
