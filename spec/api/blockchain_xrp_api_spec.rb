...
# Unit tests for SwaggerClient::BlockchainXRPApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlockchainXRPApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BlockchainXRPApi.new
  end
  ...
  describe 'test an instance of BlockchainXRPApi' do
    it 'should create an instance of BlockchainXRPApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BlockchainXRPApi)
    end
  end
