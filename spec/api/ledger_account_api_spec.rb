...
# Unit tests for SwaggerClient::LedgerAccountApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgerAccountApi' do
  before do
    # run before each test
    @instance = SwaggerClient::LedgerAccountApi.new
  end
  ...
  describe 'test an instance of LedgerAccountApi' do
    it 'should create an instance of LedgerAccountApi' do
      expect(@instance).to be_instance_of(SwaggerClient::LedgerAccountApi)
    end
  end
