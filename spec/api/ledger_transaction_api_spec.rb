...
# Unit tests for SwaggerClient::LedgerTransactionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgerTransactionApi' do
  before do
    # run before each test
    @instance = SwaggerClient::LedgerTransactionApi.new
  end
  ...
  describe 'test an instance of LedgerTransactionApi' do
    it 'should create an instance of LedgerTransactionApi' do
      expect(@instance).to be_instance_of(SwaggerClient::LedgerTransactionApi)
    end
  end
