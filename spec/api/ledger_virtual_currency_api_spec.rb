...
# Unit tests for Tatum::LedgerVirtualCurrencyApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgerVirtualCurrencyApi' do
  before do
    # run before each test
    @instance = Tatum::LedgerVirtualCurrencyApi.new
  end
  ...
  describe 'test an instance of LedgerVirtualCurrencyApi' do
    it 'should create an instance of LedgerVirtualCurrencyApi' do
      expect(@instance).to be_instance_of(Tatum::LedgerVirtualCurrencyApi)
    end
  end
