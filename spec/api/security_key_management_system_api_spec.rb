...
# Unit tests for Tatum::SecurityKeyManagementSystemApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SecurityKeyManagementSystemApi' do
  before do
    # run before each test
    @instance = Tatum::SecurityKeyManagementSystemApi.new
  end
  ...
  describe 'test an instance of SecurityKeyManagementSystemApi' do
    it 'should create an instance of SecurityKeyManagementSystemApi' do
      expect(@instance).to be_instance_of(Tatum::SecurityKeyManagementSystemApi)
    end
  end
