...
# Unit tests for SwaggerClient::AddNftMinterKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddNftMinterKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::AddNftMinterKMS.new
  end
  ...
  describe 'test an instance of AddNftMinterKMS' do
    it 'should create an instance of AddNftMinterKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::AddNftMinterKMS)
    end
  end
