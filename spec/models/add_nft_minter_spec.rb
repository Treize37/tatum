...
# Unit tests for SwaggerClient::AddNftMinter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddNftMinter' do
  before do
    # run before each test
    @instance = SwaggerClient::AddNftMinter.new
  end
  ...
  describe 'test an instance of AddNftMinter' do
    it 'should create an instance of AddNftMinter' do
      expect(@instance).to be_instance_of(SwaggerClient::AddNftMinter)
    end
  end
