...
# Unit tests for SwaggerClient::ApproveCeloErc20KMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApproveCeloErc20KMS' do
  before do
    # run before each test
    @instance = SwaggerClient::ApproveCeloErc20KMS.new
  end
  ...
  describe 'test an instance of ApproveCeloErc20KMS' do
    it 'should create an instance of ApproveCeloErc20KMS' do
      expect(@instance).to be_instance_of(SwaggerClient::ApproveCeloErc20KMS)
    end
  end
