...
# Unit tests for Tatum::ApproveNftSpendingCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApproveNftSpendingCeloKMS' do
  before do
    # run before each test
    @instance = Tatum::ApproveNftSpendingCeloKMS.new
  end
  ...
  describe 'test an instance of ApproveNftSpendingCeloKMS' do
    it 'should create an instance of ApproveNftSpendingCeloKMS' do
      expect(@instance).to be_instance_of(Tatum::ApproveNftSpendingCeloKMS)
    end
  end
