...
# Unit tests for SwaggerClient::BidOnAuctionCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BidOnAuctionCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::BidOnAuctionCeloKMS.new
  end
  ...
  describe 'test an instance of BidOnAuctionCeloKMS' do
    it 'should create an instance of BidOnAuctionCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::BidOnAuctionCeloKMS)
    end
  end
