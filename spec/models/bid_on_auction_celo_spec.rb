...
# Unit tests for SwaggerClient::BidOnAuctionCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BidOnAuctionCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BidOnAuctionCelo.new
  end
  ...
  describe 'test an instance of BidOnAuctionCelo' do
    it 'should create an instance of BidOnAuctionCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BidOnAuctionCelo)
    end
  end
