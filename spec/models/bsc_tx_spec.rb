...
# Unit tests for SwaggerClient::BscTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BscTx' do
  before do
    # run before each test
    @instance = SwaggerClient::BscTx.new
  end
  ...
  describe 'test an instance of BscTx' do
    it 'should create an instance of BscTx' do
      expect(@instance).to be_instance_of(SwaggerClient::BscTx)
    end
  end
