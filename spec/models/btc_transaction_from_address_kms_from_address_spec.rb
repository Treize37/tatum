...
# Unit tests for SwaggerClient::BtcTransactionFromAddressKMSFromAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BtcTransactionFromAddressKMSFromAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::BtcTransactionFromAddressKMSFromAddress.new
  end
  ...
  describe 'test an instance of BtcTransactionFromAddressKMSFromAddress' do
    it 'should create an instance of BtcTransactionFromAddressKMSFromAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::BtcTransactionFromAddressKMSFromAddress)
    end
  end
