...
# Unit tests for SwaggerClient::BurnErc20KMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnErc20KMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnErc20KMSCelo.new
  end
  ...
  describe 'test an instance of BurnErc20KMSCelo' do
    it 'should create an instance of BurnErc20KMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnErc20KMSCelo)
    end
  end
