...
# Unit tests for SwaggerClient::BurnErc721Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnErc721Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnErc721Celo.new
  end
  ...
  describe 'test an instance of BurnErc721Celo' do
    it 'should create an instance of BurnErc721Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnErc721Celo)
    end
  end
