...
# Unit tests for SwaggerClient::BurnErc721KMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnErc721KMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnErc721KMSCelo.new
  end
  ...
  describe 'test an instance of BurnErc721KMSCelo' do
    it 'should create an instance of BurnErc721KMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnErc721KMSCelo)
    end
  end
