...
# Unit tests for SwaggerClient::BurnMultiTokenBatchCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenBatchCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenBatchCelo.new
  end
  ...
  describe 'test an instance of BurnMultiTokenBatchCelo' do
    it 'should create an instance of BurnMultiTokenBatchCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenBatchCelo)
    end
  end
