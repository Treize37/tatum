...
# Unit tests for SwaggerClient::BurnMultiTokenBatchKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenBatchKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenBatchKMSCelo.new
  end
  ...
  describe 'test an instance of BurnMultiTokenBatchKMSCelo' do
    it 'should create an instance of BurnMultiTokenBatchKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenBatchKMSCelo)
    end
  end
