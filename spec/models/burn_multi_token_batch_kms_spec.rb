...
# Unit tests for SwaggerClient::BurnMultiTokenBatchKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenBatchKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenBatchKMS.new
  end
  ...
  describe 'test an instance of BurnMultiTokenBatchKMS' do
    it 'should create an instance of BurnMultiTokenBatchKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenBatchKMS)
    end
  end
