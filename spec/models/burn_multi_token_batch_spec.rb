...
# Unit tests for SwaggerClient::BurnMultiTokenBatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenBatch' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenBatch.new
  end
  ...
  describe 'test an instance of BurnMultiTokenBatch' do
    it 'should create an instance of BurnMultiTokenBatch' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenBatch)
    end
  end
