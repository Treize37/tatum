...
# Unit tests for SwaggerClient::BurnMultiTokenCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenCelo.new
  end
  ...
  describe 'test an instance of BurnMultiTokenCelo' do
    it 'should create an instance of BurnMultiTokenCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenCelo)
    end
  end
