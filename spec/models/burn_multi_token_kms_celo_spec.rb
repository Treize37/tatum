...
# Unit tests for SwaggerClient::BurnMultiTokenKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnMultiTokenKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnMultiTokenKMSCelo.new
  end
  ...
  describe 'test an instance of BurnMultiTokenKMSCelo' do
    it 'should create an instance of BurnMultiTokenKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnMultiTokenKMSCelo)
    end
  end
