...
# Unit tests for SwaggerClient::BurnNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnNftCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnNftCelo.new
  end
  ...
  describe 'test an instance of BurnNftCelo' do
    it 'should create an instance of BurnNftCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnNftCelo)
    end
  end
