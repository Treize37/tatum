...
# Unit tests for SwaggerClient::BurnNftFlowKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnNftFlowKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnNftFlowKMS.new
  end
  ...
  describe 'test an instance of BurnNftFlowKMS' do
    it 'should create an instance of BurnNftFlowKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnNftFlowKMS)
    end
  end
