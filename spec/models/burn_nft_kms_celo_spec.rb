...
# Unit tests for SwaggerClient::BurnNftKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnNftKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnNftKMSCelo.new
  end
  ...
  describe 'test an instance of BurnNftKMSCelo' do
    it 'should create an instance of BurnNftKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnNftKMSCelo)
    end
  end
