...
# Unit tests for SwaggerClient::BurnNftKMSTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BurnNftKMSTron' do
  before do
    # run before each test
    @instance = SwaggerClient::BurnNftKMSTron.new
  end
  ...
  describe 'test an instance of BurnNftKMSTron' do
    it 'should create an instance of BurnNftKMSTron' do
      expect(@instance).to be_instance_of(SwaggerClient::BurnNftKMSTron)
    end
  end
