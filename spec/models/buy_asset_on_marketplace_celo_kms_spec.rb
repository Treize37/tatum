...
# Unit tests for SwaggerClient::BuyAssetOnMarketplaceCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyAssetOnMarketplaceCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::BuyAssetOnMarketplaceCeloKMS.new
  end
  ...
  describe 'test an instance of BuyAssetOnMarketplaceCeloKMS' do
    it 'should create an instance of BuyAssetOnMarketplaceCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::BuyAssetOnMarketplaceCeloKMS)
    end
  end
