...
# Unit tests for SwaggerClient::BuyAssetOnMarketplaceCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyAssetOnMarketplaceCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::BuyAssetOnMarketplaceCelo.new
  end
  ...
  describe 'test an instance of BuyAssetOnMarketplaceCelo' do
    it 'should create an instance of BuyAssetOnMarketplaceCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::BuyAssetOnMarketplaceCelo)
    end
  end
