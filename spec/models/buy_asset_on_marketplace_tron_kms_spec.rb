...
# Unit tests for SwaggerClient::BuyAssetOnMarketplaceTronKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyAssetOnMarketplaceTronKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::BuyAssetOnMarketplaceTronKMS.new
  end
  ...
  describe 'test an instance of BuyAssetOnMarketplaceTronKMS' do
    it 'should create an instance of BuyAssetOnMarketplaceTronKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::BuyAssetOnMarketplaceTronKMS)
    end
  end
