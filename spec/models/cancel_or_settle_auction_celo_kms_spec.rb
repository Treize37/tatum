...
# Unit tests for SwaggerClient::CancelOrSettleAuctionCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelOrSettleAuctionCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelOrSettleAuctionCeloKMS.new
  end
  ...
  describe 'test an instance of CancelOrSettleAuctionCeloKMS' do
    it 'should create an instance of CancelOrSettleAuctionCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelOrSettleAuctionCeloKMS)
    end
  end
