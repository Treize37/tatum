...
# Unit tests for SwaggerClient::CancelOrSettleAuctionCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelOrSettleAuctionCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelOrSettleAuctionCelo.new
  end
  ...
  describe 'test an instance of CancelOrSettleAuctionCelo' do
    it 'should create an instance of CancelOrSettleAuctionCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelOrSettleAuctionCelo)
    end
  end
