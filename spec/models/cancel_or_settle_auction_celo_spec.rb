...
# Unit tests for Tatum::CancelOrSettleAuctionCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelOrSettleAuctionCelo' do
  before do
    # run before each test
    @instance = Tatum::CancelOrSettleAuctionCelo.new
  end
  ...
  describe 'test an instance of CancelOrSettleAuctionCelo' do
    it 'should create an instance of CancelOrSettleAuctionCelo' do
      expect(@instance).to be_instance_of(Tatum::CancelOrSettleAuctionCelo)
    end
  end
