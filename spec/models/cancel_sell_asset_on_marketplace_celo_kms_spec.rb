...
# Unit tests for Tatum::CancelSellAssetOnMarketplaceCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelSellAssetOnMarketplaceCeloKMS' do
  before do
    # run before each test
    @instance = Tatum::CancelSellAssetOnMarketplaceCeloKMS.new
  end
  ...
  describe 'test an instance of CancelSellAssetOnMarketplaceCeloKMS' do
    it 'should create an instance of CancelSellAssetOnMarketplaceCeloKMS' do
      expect(@instance).to be_instance_of(Tatum::CancelSellAssetOnMarketplaceCeloKMS)
    end
  end
