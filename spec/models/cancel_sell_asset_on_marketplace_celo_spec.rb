...
# Unit tests for SwaggerClient::CancelSellAssetOnMarketplaceCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelSellAssetOnMarketplaceCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelSellAssetOnMarketplaceCelo.new
  end
  ...
  describe 'test an instance of CancelSellAssetOnMarketplaceCelo' do
    it 'should create an instance of CancelSellAssetOnMarketplaceCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelSellAssetOnMarketplaceCelo)
    end
  end
