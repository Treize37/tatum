...
# Unit tests for Tatum::CancelSellAssetOnMarketplaceTronKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelSellAssetOnMarketplaceTronKMS' do
  before do
    # run before each test
    @instance = Tatum::CancelSellAssetOnMarketplaceTronKMS.new
  end
  ...
  describe 'test an instance of CancelSellAssetOnMarketplaceTronKMS' do
    it 'should create an instance of CancelSellAssetOnMarketplaceTronKMS' do
      expect(@instance).to be_instance_of(Tatum::CancelSellAssetOnMarketplaceTronKMS)
    end
  end
