...
# Unit tests for SwaggerClient::CancelSellAssetOnMarketplaceTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelSellAssetOnMarketplaceTron' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelSellAssetOnMarketplaceTron.new
  end
  ...
  describe 'test an instance of CancelSellAssetOnMarketplaceTron' do
    it 'should create an instance of CancelSellAssetOnMarketplaceTron' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelSellAssetOnMarketplaceTron)
    end
  end
