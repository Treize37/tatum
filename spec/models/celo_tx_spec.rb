...
# Unit tests for SwaggerClient::CeloTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CeloTx' do
  before do
    # run before each test
    @instance = SwaggerClient::CeloTx.new
  end
  ...
  describe 'test an instance of CeloTx' do
    it 'should create an instance of CeloTx' do
      expect(@instance).to be_instance_of(SwaggerClient::CeloTx)
    end
  end
