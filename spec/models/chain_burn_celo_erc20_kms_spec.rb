...
# Unit tests for SwaggerClient::ChainBurnCeloErc20KMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainBurnCeloErc20KMS' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainBurnCeloErc20KMS.new
  end
  ...
  describe 'test an instance of ChainBurnCeloErc20KMS' do
    it 'should create an instance of ChainBurnCeloErc20KMS' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainBurnCeloErc20KMS)
    end
  end
