...
# Unit tests for SwaggerClient::ChainBurnCeloErc20
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainBurnCeloErc20' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainBurnCeloErc20.new
  end
  ...
  describe 'test an instance of ChainBurnCeloErc20' do
    it 'should create an instance of ChainBurnCeloErc20' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainBurnCeloErc20)
    end
  end
