...
# Unit tests for SwaggerClient::ChainDeployCeloErc20KMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainDeployCeloErc20KMS' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainDeployCeloErc20KMS.new
  end
  ...
  describe 'test an instance of ChainDeployCeloErc20KMS' do
    it 'should create an instance of ChainDeployCeloErc20KMS' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainDeployCeloErc20KMS)
    end
  end
