...
# Unit tests for SwaggerClient::ChainDeployCeloErc20
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainDeployCeloErc20' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainDeployCeloErc20.new
  end
  ...
  describe 'test an instance of ChainDeployCeloErc20' do
    it 'should create an instance of ChainDeployCeloErc20' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainDeployCeloErc20)
    end
  end
