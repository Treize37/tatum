...
# Unit tests for SwaggerClient::ChainMintCeloErc20KMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainMintCeloErc20KMS' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainMintCeloErc20KMS.new
  end
  ...
  describe 'test an instance of ChainMintCeloErc20KMS' do
    it 'should create an instance of ChainMintCeloErc20KMS' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainMintCeloErc20KMS)
    end
  end
