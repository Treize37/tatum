...
# Unit tests for Tatum::ChainTransferCeloErc20TokenKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainTransferCeloErc20TokenKMS' do
  before do
    # run before each test
    @instance = Tatum::ChainTransferCeloErc20TokenKMS.new
  end
  ...
  describe 'test an instance of ChainTransferCeloErc20TokenKMS' do
    it 'should create an instance of ChainTransferCeloErc20TokenKMS' do
      expect(@instance).to be_instance_of(Tatum::ChainTransferCeloErc20TokenKMS)
    end
  end
