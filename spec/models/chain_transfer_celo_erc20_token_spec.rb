...
# Unit tests for SwaggerClient::ChainTransferCeloErc20Token
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainTransferCeloErc20Token' do
  before do
    # run before each test
    @instance = SwaggerClient::ChainTransferCeloErc20Token.new
  end
  ...
  describe 'test an instance of ChainTransferCeloErc20Token' do
    it 'should create an instance of ChainTransferCeloErc20Token' do
      expect(@instance).to be_instance_of(SwaggerClient::ChainTransferCeloErc20Token)
    end
  end
