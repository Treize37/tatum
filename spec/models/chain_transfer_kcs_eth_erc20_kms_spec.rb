...
# Unit tests for Tatum::ChainTransferKcsEthErc20KMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainTransferKcsEthErc20KMS' do
  before do
    # run before each test
    @instance = Tatum::ChainTransferKcsEthErc20KMS.new
  end
  ...
  describe 'test an instance of ChainTransferKcsEthErc20KMS' do
    it 'should create an instance of ChainTransferKcsEthErc20KMS' do
      expect(@instance).to be_instance_of(Tatum::ChainTransferKcsEthErc20KMS)
    end
  end
