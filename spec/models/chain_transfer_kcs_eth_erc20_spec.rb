...
# Unit tests for Tatum::ChainTransferKcsEthErc20
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChainTransferKcsEthErc20' do
  before do
    # run before each test
    @instance = Tatum::ChainTransferKcsEthErc20.new
  end
  ...
  describe 'test an instance of ChainTransferKcsEthErc20' do
    it 'should create an instance of ChainTransferKcsEthErc20' do
      expect(@instance).to be_instance_of(Tatum::ChainTransferKcsEthErc20)
    end
  end
