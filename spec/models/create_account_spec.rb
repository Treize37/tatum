...
# Unit tests for SwaggerClient::CreateAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateAccount.new
  end
  ...
  describe 'test an instance of CreateAccount' do
    it 'should create an instance of CreateAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateAccount)
    end
  end
