...
# Unit tests for SwaggerClient::CreateAuctionCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAuctionCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateAuctionCeloKMS.new
  end
  ...
  describe 'test an instance of CreateAuctionCeloKMS' do
    it 'should create an instance of CreateAuctionCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateAuctionCeloKMS)
    end
  end
