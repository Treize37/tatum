...
# Unit tests for SwaggerClient::CreateAuctionCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAuctionCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateAuctionCelo.new
  end
  ...
  describe 'test an instance of CreateAuctionCelo' do
    it 'should create an instance of CreateAuctionCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateAuctionCelo)
    end
  end
