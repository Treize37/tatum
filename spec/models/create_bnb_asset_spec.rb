...
# Unit tests for SwaggerClient::CreateBnbAsset
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateBnbAsset' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateBnbAsset.new
  end
  ...
  describe 'test an instance of CreateBnbAsset' do
    it 'should create an instance of CreateBnbAsset' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateBnbAsset)
    end
  end
