...
# Unit tests for SwaggerClient::CreateRecordCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateRecordCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateRecordCelo.new
  end
  ...
  describe 'test an instance of CreateRecordCelo' do
    it 'should create an instance of CreateRecordCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateRecordCelo)
    end
  end
