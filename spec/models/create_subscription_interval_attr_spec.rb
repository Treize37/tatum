...
# Unit tests for Tatum::CreateSubscriptionIntervalAttr
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubscriptionIntervalAttr' do
  before do
    # run before each test
    @instance = Tatum::CreateSubscriptionIntervalAttr.new
  end
  ...
  describe 'test an instance of CreateSubscriptionIntervalAttr' do
    it 'should create an instance of CreateSubscriptionIntervalAttr' do
      expect(@instance).to be_instance_of(Tatum::CreateSubscriptionIntervalAttr)
    end
  end
