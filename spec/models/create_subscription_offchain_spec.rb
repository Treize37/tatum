...
# Unit tests for Tatum::CreateSubscriptionOffchain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSubscriptionOffchain' do
  before do
    # run before each test
    @instance = Tatum::CreateSubscriptionOffchain.new
  end
  ...
  describe 'test an instance of CreateSubscriptionOffchain' do
    it 'should create an instance of CreateSubscriptionOffchain' do
      expect(@instance).to be_instance_of(Tatum::CreateSubscriptionOffchain)
    end
  end
