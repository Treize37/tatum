...
# Unit tests for SwaggerClient::CreateXrpAsset
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateXrpAsset' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateXrpAsset.new
  end
  ...
  describe 'test an instance of CreateXrpAsset' do
    it 'should create an instance of CreateXrpAsset' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateXrpAsset)
    end
  end
