...
# Unit tests for SwaggerClient::CustomerRegistration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerRegistration' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomerRegistration.new
  end
  ...
  describe 'test an instance of CustomerRegistration' do
    it 'should create an instance of CustomerRegistration' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomerRegistration)
    end
  end
