...
# Unit tests for SwaggerClient::DeployAlgoErc20OffchainKMSAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployAlgoErc20OffchainKMSAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployAlgoErc20OffchainKMSAddress.new
  end
  ...
  describe 'test an instance of DeployAlgoErc20OffchainKMSAddress' do
    it 'should create an instance of DeployAlgoErc20OffchainKMSAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployAlgoErc20OffchainKMSAddress)
    end
  end
