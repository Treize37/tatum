...
# Unit tests for SwaggerClient::DeployAlgoErc20OffchainMnemonicAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployAlgoErc20OffchainMnemonicAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployAlgoErc20OffchainMnemonicAddress.new
  end
  ...
  describe 'test an instance of DeployAlgoErc20OffchainMnemonicAddress' do
    it 'should create an instance of DeployAlgoErc20OffchainMnemonicAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployAlgoErc20OffchainMnemonicAddress)
    end
  end
