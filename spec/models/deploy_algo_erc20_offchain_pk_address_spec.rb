...
# Unit tests for Tatum::DeployAlgoErc20OffchainPKAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployAlgoErc20OffchainPKAddress' do
  before do
    # run before each test
    @instance = Tatum::DeployAlgoErc20OffchainPKAddress.new
  end
  ...
  describe 'test an instance of DeployAlgoErc20OffchainPKAddress' do
    it 'should create an instance of DeployAlgoErc20OffchainPKAddress' do
      expect(@instance).to be_instance_of(Tatum::DeployAlgoErc20OffchainPKAddress)
    end
  end
