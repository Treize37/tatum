...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainKMSAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainKMSAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainKMSAddress.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainKMSAddress' do
    it 'should create an instance of DeployCeloErc20OffchainKMSAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainKMSAddress)
    end
  end
