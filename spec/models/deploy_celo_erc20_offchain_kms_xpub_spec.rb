...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainKMSXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainKMSXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainKMSXpub.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainKMSXpub' do
    it 'should create an instance of DeployCeloErc20OffchainKMSXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainKMSXpub)
    end
  end
