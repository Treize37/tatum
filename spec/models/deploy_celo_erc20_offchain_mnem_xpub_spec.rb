...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainMnemXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainMnemXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainMnemXpub.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainMnemXpub' do
    it 'should create an instance of DeployCeloErc20OffchainMnemXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainMnemXpub)
    end
  end
