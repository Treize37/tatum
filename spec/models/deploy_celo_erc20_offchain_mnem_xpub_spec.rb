...
# Unit tests for Tatum::DeployCeloErc20OffchainMnemXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainMnemXpub' do
  before do
    # run before each test
    @instance = Tatum::DeployCeloErc20OffchainMnemXpub.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainMnemXpub' do
    it 'should create an instance of DeployCeloErc20OffchainMnemXpub' do
      expect(@instance).to be_instance_of(Tatum::DeployCeloErc20OffchainMnemXpub)
    end
  end
