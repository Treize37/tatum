...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainMnemonicAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainMnemonicAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainMnemonicAddress.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainMnemonicAddress' do
    it 'should create an instance of DeployCeloErc20OffchainMnemonicAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainMnemonicAddress)
    end
  end
