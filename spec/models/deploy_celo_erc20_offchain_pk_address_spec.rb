...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainPKAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainPKAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainPKAddress.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainPKAddress' do
    it 'should create an instance of DeployCeloErc20OffchainPKAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainPKAddress)
    end
  end
