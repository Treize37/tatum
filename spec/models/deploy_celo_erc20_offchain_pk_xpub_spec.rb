...
# Unit tests for SwaggerClient::DeployCeloErc20OffchainPKXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainPKXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployCeloErc20OffchainPKXpub.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainPKXpub' do
    it 'should create an instance of DeployCeloErc20OffchainPKXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployCeloErc20OffchainPKXpub)
    end
  end
