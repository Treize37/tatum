...
# Unit tests for Tatum::DeployCeloErc20OffchainPKXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployCeloErc20OffchainPKXpub' do
  before do
    # run before each test
    @instance = Tatum::DeployCeloErc20OffchainPKXpub.new
  end
  ...
  describe 'test an instance of DeployCeloErc20OffchainPKXpub' do
    it 'should create an instance of DeployCeloErc20OffchainPKXpub' do
      expect(@instance).to be_instance_of(Tatum::DeployCeloErc20OffchainPKXpub)
    end
  end
