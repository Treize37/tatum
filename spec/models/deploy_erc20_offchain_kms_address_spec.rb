...
# Unit tests for SwaggerClient::DeployErc20OffchainKMSAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainKMSAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc20OffchainKMSAddress.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainKMSAddress' do
    it 'should create an instance of DeployErc20OffchainKMSAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc20OffchainKMSAddress)
    end
  end
