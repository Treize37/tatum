...
# Unit tests for SwaggerClient::DeployErc20OffchainKMSXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainKMSXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc20OffchainKMSXpub.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainKMSXpub' do
    it 'should create an instance of DeployErc20OffchainKMSXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc20OffchainKMSXpub)
    end
  end
