...
# Unit tests for Tatum::DeployErc20OffchainMnemXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainMnemXpub' do
  before do
    # run before each test
    @instance = Tatum::DeployErc20OffchainMnemXpub.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainMnemXpub' do
    it 'should create an instance of DeployErc20OffchainMnemXpub' do
      expect(@instance).to be_instance_of(Tatum::DeployErc20OffchainMnemXpub)
    end
  end
