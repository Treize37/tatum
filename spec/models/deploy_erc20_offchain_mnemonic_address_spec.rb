...
# Unit tests for SwaggerClient::DeployErc20OffchainMnemonicAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainMnemonicAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc20OffchainMnemonicAddress.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainMnemonicAddress' do
    it 'should create an instance of DeployErc20OffchainMnemonicAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc20OffchainMnemonicAddress)
    end
  end
