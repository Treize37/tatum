...
# Unit tests for Tatum::DeployErc20OffchainPKAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainPKAddress' do
  before do
    # run before each test
    @instance = Tatum::DeployErc20OffchainPKAddress.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainPKAddress' do
    it 'should create an instance of DeployErc20OffchainPKAddress' do
      expect(@instance).to be_instance_of(Tatum::DeployErc20OffchainPKAddress)
    end
  end
