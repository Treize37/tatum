...
# Unit tests for SwaggerClient::DeployErc20OffchainPKXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20OffchainPKXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc20OffchainPKXpub.new
  end
  ...
  describe 'test an instance of DeployErc20OffchainPKXpub' do
    it 'should create an instance of DeployErc20OffchainPKXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc20OffchainPKXpub)
    end
  end
