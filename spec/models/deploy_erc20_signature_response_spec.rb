...
# Unit tests for Tatum::DeployErc20SignatureResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc20SignatureResponse' do
  before do
    # run before each test
    @instance = Tatum::DeployErc20SignatureResponse.new
  end
  ...
  describe 'test an instance of DeployErc20SignatureResponse' do
    it 'should create an instance of DeployErc20SignatureResponse' do
      expect(@instance).to be_instance_of(Tatum::DeployErc20SignatureResponse)
    end
  end
