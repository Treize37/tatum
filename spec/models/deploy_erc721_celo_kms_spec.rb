...
# Unit tests for SwaggerClient::DeployErc721CeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc721CeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc721CeloKMS.new
  end
  ...
  describe 'test an instance of DeployErc721CeloKMS' do
    it 'should create an instance of DeployErc721CeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc721CeloKMS)
    end
  end
