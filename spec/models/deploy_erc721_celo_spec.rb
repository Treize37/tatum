...
# Unit tests for SwaggerClient::DeployErc721Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployErc721Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployErc721Celo.new
  end
  ...
  describe 'test an instance of DeployErc721Celo' do
    it 'should create an instance of DeployErc721Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployErc721Celo)
    end
  end
