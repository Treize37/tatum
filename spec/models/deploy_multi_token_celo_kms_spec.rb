...
# Unit tests for SwaggerClient::DeployMultiTokenCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployMultiTokenCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployMultiTokenCeloKMS.new
  end
  ...
  describe 'test an instance of DeployMultiTokenCeloKMS' do
    it 'should create an instance of DeployMultiTokenCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployMultiTokenCeloKMS)
    end
  end
