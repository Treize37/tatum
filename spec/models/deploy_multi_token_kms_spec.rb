...
# Unit tests for SwaggerClient::DeployMultiTokenKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployMultiTokenKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployMultiTokenKMS.new
  end
  ...
  describe 'test an instance of DeployMultiTokenKMS' do
    it 'should create an instance of DeployMultiTokenKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployMultiTokenKMS)
    end
  end
