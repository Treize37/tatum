...
# Unit tests for SwaggerClient::DeployNftCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployNftCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployNftCeloKMS.new
  end
  ...
  describe 'test an instance of DeployNftCeloKMS' do
    it 'should create an instance of DeployNftCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployNftCeloKMS)
    end
  end
