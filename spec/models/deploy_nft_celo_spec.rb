...
# Unit tests for SwaggerClient::DeployNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployNftCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployNftCelo.new
  end
  ...
  describe 'test an instance of DeployNftCelo' do
    it 'should create an instance of DeployNftCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployNftCelo)
    end
  end
