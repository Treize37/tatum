...
# Unit tests for Tatum::DeployTrcOffchainKMSAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployTrcOffchainKMSAddress' do
  before do
    # run before each test
    @instance = Tatum::DeployTrcOffchainKMSAddress.new
  end
  ...
  describe 'test an instance of DeployTrcOffchainKMSAddress' do
    it 'should create an instance of DeployTrcOffchainKMSAddress' do
      expect(@instance).to be_instance_of(Tatum::DeployTrcOffchainKMSAddress)
    end
  end
