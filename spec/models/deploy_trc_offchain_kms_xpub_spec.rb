...
# Unit tests for Tatum::DeployTrcOffchainKMSXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployTrcOffchainKMSXpub' do
  before do
    # run before each test
    @instance = Tatum::DeployTrcOffchainKMSXpub.new
  end
  ...
  describe 'test an instance of DeployTrcOffchainKMSXpub' do
    it 'should create an instance of DeployTrcOffchainKMSXpub' do
      expect(@instance).to be_instance_of(Tatum::DeployTrcOffchainKMSXpub)
    end
  end
