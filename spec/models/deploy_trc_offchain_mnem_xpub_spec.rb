...
# Unit tests for SwaggerClient::DeployTrcOffchainMnemXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployTrcOffchainMnemXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployTrcOffchainMnemXpub.new
  end
  ...
  describe 'test an instance of DeployTrcOffchainMnemXpub' do
    it 'should create an instance of DeployTrcOffchainMnemXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployTrcOffchainMnemXpub)
    end
  end
