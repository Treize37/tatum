...
# Unit tests for SwaggerClient::DeployTrcOffchainPKAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployTrcOffchainPKAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployTrcOffchainPKAddress.new
  end
  ...
  describe 'test an instance of DeployTrcOffchainPKAddress' do
    it 'should create an instance of DeployTrcOffchainPKAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployTrcOffchainPKAddress)
    end
  end
