...
# Unit tests for SwaggerClient::DeployTrcOffchainPKXpub
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeployTrcOffchainPKXpub' do
  before do
    # run before each test
    @instance = SwaggerClient::DeployTrcOffchainPKXpub.new
  end
  ...
  describe 'test an instance of DeployTrcOffchainPKXpub' do
    it 'should create an instance of DeployTrcOffchainPKXpub' do
      expect(@instance).to be_instance_of(SwaggerClient::DeployTrcOffchainPKXpub)
    end
  end
