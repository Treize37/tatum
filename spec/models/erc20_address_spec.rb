...
# Unit tests for SwaggerClient::Erc20Address
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Erc20Address' do
  before do
    # run before each test
    @instance = SwaggerClient::Erc20Address.new
  end
  ...
  describe 'test an instance of Erc20Address' do
    it 'should create an instance of Erc20Address' do
      expect(@instance).to be_instance_of(SwaggerClient::Erc20Address)
    end
  end
