...
# Unit tests for SwaggerClient::Erc20
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Erc20' do
  before do
    # run before each test
    @instance = SwaggerClient::Erc20.new
  end
  ...
  describe 'test an instance of Erc20' do
    it 'should create an instance of Erc20' do
      expect(@instance).to be_instance_of(SwaggerClient::Erc20)
    end
  end
