...
# Unit tests for Tatum::Error403BscMnemonicPrivateKey
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error403BscMnemonicPrivateKey' do
  before do
    # run before each test
    @instance = Tatum::Error403BscMnemonicPrivateKey.new
  end
  ...
  describe 'test an instance of Error403BscMnemonicPrivateKey' do
    it 'should create an instance of Error403BscMnemonicPrivateKey' do
      expect(@instance).to be_instance_of(Tatum::Error403BscMnemonicPrivateKey)
    end
  end
