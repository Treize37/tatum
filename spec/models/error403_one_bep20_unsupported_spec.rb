...
# Unit tests for Tatum::Error403OneBep20Unsupported
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error403OneBep20Unsupported' do
  before do
    # run before each test
    @instance = Tatum::Error403OneBep20Unsupported.new
  end
  ...
  describe 'test an instance of Error403OneBep20Unsupported' do
    it 'should create an instance of Error403OneBep20Unsupported' do
      expect(@instance).to be_instance_of(Tatum::Error403OneBep20Unsupported)
    end
  end
