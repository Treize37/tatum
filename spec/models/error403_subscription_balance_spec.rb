...
# Unit tests for SwaggerClient::Error403SubscriptionBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error403SubscriptionBalance' do
  before do
    # run before each test
    @instance = SwaggerClient::Error403SubscriptionBalance.new
  end
  ...
  describe 'test an instance of Error403SubscriptionBalance' do
    it 'should create an instance of Error403SubscriptionBalance' do
      expect(@instance).to be_instance_of(SwaggerClient::Error403SubscriptionBalance)
    end
  end
