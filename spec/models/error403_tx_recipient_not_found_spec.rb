...
# Unit tests for SwaggerClient::Error403TxRecipientNotFound
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error403TxRecipientNotFound' do
  before do
    # run before each test
    @instance = SwaggerClient::Error403TxRecipientNotFound.new
  end
  ...
  describe 'test an instance of Error403TxRecipientNotFound' do
    it 'should create an instance of Error403TxRecipientNotFound' do
      expect(@instance).to be_instance_of(SwaggerClient::Error403TxRecipientNotFound)
    end
  end
