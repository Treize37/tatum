...
# Unit tests for SwaggerClient::EstimateFeeFromAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EstimateFeeFromAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::EstimateFeeFromAddress.new
  end
  ...
  describe 'test an instance of EstimateFeeFromAddress' do
    it 'should create an instance of EstimateFeeFromAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::EstimateFeeFromAddress)
    end
  end
