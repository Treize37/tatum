...
# Unit tests for SwaggerClient::EthTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EthTx' do
  before do
    # run before each test
    @instance = SwaggerClient::EthTx.new
  end
  ...
  describe 'test an instance of EthTx' do
    it 'should create an instance of EthTx' do
      expect(@instance).to be_instance_of(SwaggerClient::EthTx)
    end
  end
