...
# Unit tests for Tatum::FlowCreateAddressFromPubKeySecret
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlowCreateAddressFromPubKeySecret' do
  before do
    # run before each test
    @instance = Tatum::FlowCreateAddressFromPubKeySecret.new
  end
  ...
  describe 'test an instance of FlowCreateAddressFromPubKeySecret' do
    it 'should create an instance of FlowCreateAddressFromPubKeySecret' do
      expect(@instance).to be_instance_of(Tatum::FlowCreateAddressFromPubKeySecret)
    end
  end
