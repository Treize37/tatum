...
# Unit tests for SwaggerClient::GenerateAuctionCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateAuctionCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::GenerateAuctionCeloKMS.new
  end
  ...
  describe 'test an instance of GenerateAuctionCeloKMS' do
    it 'should create an instance of GenerateAuctionCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::GenerateAuctionCeloKMS)
    end
  end
