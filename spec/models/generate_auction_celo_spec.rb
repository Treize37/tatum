...
# Unit tests for SwaggerClient::GenerateAuctionCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateAuctionCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::GenerateAuctionCelo.new
  end
  ...
  describe 'test an instance of GenerateAuctionCelo' do
    it 'should create an instance of GenerateAuctionCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::GenerateAuctionCelo)
    end
  end
