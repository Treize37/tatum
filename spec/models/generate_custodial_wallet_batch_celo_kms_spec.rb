...
# Unit tests for SwaggerClient::GenerateCustodialWalletBatchCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateCustodialWalletBatchCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::GenerateCustodialWalletBatchCeloKMS.new
  end
  ...
  describe 'test an instance of GenerateCustodialWalletBatchCeloKMS' do
    it 'should create an instance of GenerateCustodialWalletBatchCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::GenerateCustodialWalletBatchCeloKMS)
    end
  end
