...
# Unit tests for Tatum::GenerateCustodialWalletBatchCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateCustodialWalletBatchCelo' do
  before do
    # run before each test
    @instance = Tatum::GenerateCustodialWalletBatchCelo.new
  end
  ...
  describe 'test an instance of GenerateCustodialWalletBatchCelo' do
    it 'should create an instance of GenerateCustodialWalletBatchCelo' do
      expect(@instance).to be_instance_of(Tatum::GenerateCustodialWalletBatchCelo)
    end
  end
