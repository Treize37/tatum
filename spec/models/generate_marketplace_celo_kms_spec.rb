...
# Unit tests for SwaggerClient::GenerateMarketplaceCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateMarketplaceCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::GenerateMarketplaceCeloKMS.new
  end
  ...
  describe 'test an instance of GenerateMarketplaceCeloKMS' do
    it 'should create an instance of GenerateMarketplaceCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::GenerateMarketplaceCeloKMS)
    end
  end
