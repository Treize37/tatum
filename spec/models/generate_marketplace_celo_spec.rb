...
# Unit tests for SwaggerClient::GenerateMarketplaceCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenerateMarketplaceCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::GenerateMarketplaceCelo.new
  end
  ...
  describe 'test an instance of GenerateMarketplaceCelo' do
    it 'should create an instance of GenerateMarketplaceCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::GenerateMarketplaceCelo)
    end
  end
