...
# Unit tests for Tatum::InlineResponse20034
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20034' do
  before do
    # run before each test
    @instance = Tatum::InlineResponse20034.new
  end
  ...
  describe 'test an instance of InlineResponse20034' do
    it 'should create an instance of InlineResponse20034' do
      expect(@instance).to be_instance_of(Tatum::InlineResponse20034)
    end
  end
  ...
  describe 'test attribute "rollover_day"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
