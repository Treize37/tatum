...
# Unit tests for SwaggerClient::LtcTransactionAddressKMSFromAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LtcTransactionAddressKMSFromAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::LtcTransactionAddressKMSFromAddress.new
  end
  ...
  describe 'test an instance of LtcTransactionAddressKMSFromAddress' do
    it 'should create an instance of LtcTransactionAddressKMSFromAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::LtcTransactionAddressKMSFromAddress)
    end
  end
