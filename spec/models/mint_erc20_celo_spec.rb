...
# Unit tests for SwaggerClient::MintErc20Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintErc20Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintErc20Celo.new
  end
  ...
  describe 'test an instance of MintErc20Celo' do
    it 'should create an instance of MintErc20Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintErc20Celo)
    end
  end
