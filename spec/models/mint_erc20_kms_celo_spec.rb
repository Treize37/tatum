...
# Unit tests for SwaggerClient::MintErc20KMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintErc20KMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintErc20KMSCelo.new
  end
  ...
  describe 'test an instance of MintErc20KMSCelo' do
    it 'should create an instance of MintErc20KMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintErc20KMSCelo)
    end
  end
