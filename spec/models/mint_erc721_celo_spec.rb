...
# Unit tests for SwaggerClient::MintErc721Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintErc721Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintErc721Celo.new
  end
  ...
  describe 'test an instance of MintErc721Celo' do
    it 'should create an instance of MintErc721Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintErc721Celo)
    end
  end
