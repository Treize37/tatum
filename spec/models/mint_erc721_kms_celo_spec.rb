...
# Unit tests for SwaggerClient::MintErc721KMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintErc721KMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintErc721KMSCelo.new
  end
  ...
  describe 'test an instance of MintErc721KMSCelo' do
    it 'should create an instance of MintErc721KMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintErc721KMSCelo)
    end
  end
