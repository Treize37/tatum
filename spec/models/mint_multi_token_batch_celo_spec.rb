...
# Unit tests for SwaggerClient::MintMultiTokenBatchCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenBatchCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenBatchCelo.new
  end
  ...
  describe 'test an instance of MintMultiTokenBatchCelo' do
    it 'should create an instance of MintMultiTokenBatchCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenBatchCelo)
    end
  end
