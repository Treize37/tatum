...
# Unit tests for SwaggerClient::MintMultiTokenBatchKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenBatchKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenBatchKMSCelo.new
  end
  ...
  describe 'test an instance of MintMultiTokenBatchKMSCelo' do
    it 'should create an instance of MintMultiTokenBatchKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenBatchKMSCelo)
    end
  end
