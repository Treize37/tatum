...
# Unit tests for SwaggerClient::MintMultiTokenBatchKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenBatchKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenBatchKMS.new
  end
  ...
  describe 'test an instance of MintMultiTokenBatchKMS' do
    it 'should create an instance of MintMultiTokenBatchKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenBatchKMS)
    end
  end
