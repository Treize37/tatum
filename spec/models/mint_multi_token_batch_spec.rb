...
# Unit tests for SwaggerClient::MintMultiTokenBatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenBatch' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenBatch.new
  end
  ...
  describe 'test an instance of MintMultiTokenBatch' do
    it 'should create an instance of MintMultiTokenBatch' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenBatch)
    end
  end
