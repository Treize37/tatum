...
# Unit tests for SwaggerClient::MintMultiTokenCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenCelo.new
  end
  ...
  describe 'test an instance of MintMultiTokenCelo' do
    it 'should create an instance of MintMultiTokenCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenCelo)
    end
  end
