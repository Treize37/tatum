...
# Unit tests for SwaggerClient::MintMultiTokenKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenKMSCelo.new
  end
  ...
  describe 'test an instance of MintMultiTokenKMSCelo' do
    it 'should create an instance of MintMultiTokenKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenKMSCelo)
    end
  end
