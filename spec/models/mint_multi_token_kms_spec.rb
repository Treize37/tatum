...
# Unit tests for SwaggerClient::MintMultiTokenKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultiTokenKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultiTokenKMS.new
  end
  ...
  describe 'test an instance of MintMultiTokenKMS' do
    it 'should create an instance of MintMultiTokenKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultiTokenKMS)
    end
  end
