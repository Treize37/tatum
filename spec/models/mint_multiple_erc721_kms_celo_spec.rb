...
# Unit tests for Tatum::MintMultipleErc721KMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultipleErc721KMSCelo' do
  before do
    # run before each test
    @instance = Tatum::MintMultipleErc721KMSCelo.new
  end
  ...
  describe 'test an instance of MintMultipleErc721KMSCelo' do
    it 'should create an instance of MintMultipleErc721KMSCelo' do
      expect(@instance).to be_instance_of(Tatum::MintMultipleErc721KMSCelo)
    end
  end
