...
# Unit tests for SwaggerClient::MintMultipleNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultipleNftCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultipleNftCelo.new
  end
  ...
  describe 'test an instance of MintMultipleNftCelo' do
    it 'should create an instance of MintMultipleNftCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultipleNftCelo)
    end
  end
