...
# Unit tests for SwaggerClient::MintMultipleNftKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultipleNftKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultipleNftKMSCelo.new
  end
  ...
  describe 'test an instance of MintMultipleNftKMSCelo' do
    it 'should create an instance of MintMultipleNftKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultipleNftKMSCelo)
    end
  end
