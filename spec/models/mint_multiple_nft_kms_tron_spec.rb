...
# Unit tests for SwaggerClient::MintMultipleNftKMSTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultipleNftKMSTron' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultipleNftKMSTron.new
  end
  ...
  describe 'test an instance of MintMultipleNftKMSTron' do
    it 'should create an instance of MintMultipleNftKMSTron' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultipleNftKMSTron)
    end
  end
