...
# Unit tests for SwaggerClient::MintMultipleNftTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintMultipleNftTron' do
  before do
    # run before each test
    @instance = SwaggerClient::MintMultipleNftTron.new
  end
  ...
  describe 'test an instance of MintMultipleNftTron' do
    it 'should create an instance of MintMultipleNftTron' do
      expect(@instance).to be_instance_of(SwaggerClient::MintMultipleNftTron)
    end
  end
