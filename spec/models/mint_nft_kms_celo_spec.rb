...
# Unit tests for SwaggerClient::MintNftKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MintNftKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::MintNftKMSCelo.new
  end
  ...
  describe 'test an instance of MintNftKMSCelo' do
    it 'should create an instance of MintNftKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::MintNftKMSCelo)
    end
  end
