...
# Unit tests for SwaggerClient::OneTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneTx' do
  before do
    # run before each test
    @instance = SwaggerClient::OneTx.new
  end
  ...
  describe 'test an instance of OneTx' do
    it 'should create an instance of OneTx' do
      expect(@instance).to be_instance_of(SwaggerClient::OneTx)
    end
  end
