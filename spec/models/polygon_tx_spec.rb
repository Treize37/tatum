...
# Unit tests for SwaggerClient::PolygonTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolygonTx' do
  before do
    # run before each test
    @instance = SwaggerClient::PolygonTx.new
  end
  ...
  describe 'test an instance of PolygonTx' do
    it 'should create an instance of PolygonTx' do
      expect(@instance).to be_instance_of(SwaggerClient::PolygonTx)
    end
  end
