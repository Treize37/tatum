...
# Unit tests for SwaggerClient::ScryptaTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScryptaTransaction' do
  before do
    # run before each test
    @instance = SwaggerClient::ScryptaTransaction.new
  end
  ...
  describe 'test an instance of ScryptaTransaction' do
    it 'should create an instance of ScryptaTransaction' do
      expect(@instance).to be_instance_of(SwaggerClient::ScryptaTransaction)
    end
  end
