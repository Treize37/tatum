...
# Unit tests for Tatum::SellAssetOnMarketplaceCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellAssetOnMarketplaceCeloKMS' do
  before do
    # run before each test
    @instance = Tatum::SellAssetOnMarketplaceCeloKMS.new
  end
  ...
  describe 'test an instance of SellAssetOnMarketplaceCeloKMS' do
    it 'should create an instance of SellAssetOnMarketplaceCeloKMS' do
      expect(@instance).to be_instance_of(Tatum::SellAssetOnMarketplaceCeloKMS)
    end
  end
