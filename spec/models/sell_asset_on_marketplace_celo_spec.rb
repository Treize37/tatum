...
# Unit tests for SwaggerClient::SellAssetOnMarketplaceCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellAssetOnMarketplaceCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::SellAssetOnMarketplaceCelo.new
  end
  ...
  describe 'test an instance of SellAssetOnMarketplaceCelo' do
    it 'should create an instance of SellAssetOnMarketplaceCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::SellAssetOnMarketplaceCelo)
    end
  end
