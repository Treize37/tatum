...
# Unit tests for SwaggerClient::SolanaTxTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolanaTxTransaction' do
  before do
    # run before each test
    @instance = SwaggerClient::SolanaTxTransaction.new
  end
  ...
  describe 'test an instance of SolanaTxTransaction' do
    it 'should create an instance of SolanaTxTransaction' do
      expect(@instance).to be_instance_of(SwaggerClient::SolanaTxTransaction)
    end
  end
