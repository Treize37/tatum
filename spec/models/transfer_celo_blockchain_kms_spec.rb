...
# Unit tests for Tatum::TransferCeloBlockchainKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferCeloBlockchainKMS' do
  before do
    # run before each test
    @instance = Tatum::TransferCeloBlockchainKMS.new
  end
  ...
  describe 'test an instance of TransferCeloBlockchainKMS' do
    it 'should create an instance of TransferCeloBlockchainKMS' do
      expect(@instance).to be_instance_of(Tatum::TransferCeloBlockchainKMS)
    end
  end
