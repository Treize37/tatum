...
# Unit tests for SwaggerClient::TransferCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferCeloKMS.new
  end
  ...
  describe 'test an instance of TransferCeloKMS' do
    it 'should create an instance of TransferCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferCeloKMS)
    end
  end
