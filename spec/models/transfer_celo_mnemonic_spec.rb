...
# Unit tests for SwaggerClient::TransferCeloMnemonic
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferCeloMnemonic' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferCeloMnemonic.new
  end
  ...
  describe 'test an instance of TransferCeloMnemonic' do
    it 'should create an instance of TransferCeloMnemonic' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferCeloMnemonic)
    end
  end
