...
# Unit tests for SwaggerClient::TransferCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferCelo.new
  end
  ...
  describe 'test an instance of TransferCelo' do
    it 'should create an instance of TransferCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferCelo)
    end
  end
