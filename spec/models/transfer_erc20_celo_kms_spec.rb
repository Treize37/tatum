...
# Unit tests for SwaggerClient::TransferErc20CeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferErc20CeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferErc20CeloKMS.new
  end
  ...
  describe 'test an instance of TransferErc20CeloKMS' do
    it 'should create an instance of TransferErc20CeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferErc20CeloKMS)
    end
  end
