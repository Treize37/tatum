...
# Unit tests for SwaggerClient::TransferErc20Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferErc20Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferErc20Celo.new
  end
  ...
  describe 'test an instance of TransferErc20Celo' do
    it 'should create an instance of TransferErc20Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferErc20Celo)
    end
  end
