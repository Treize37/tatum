...
# Unit tests for SwaggerClient::TransferErc721Celo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferErc721Celo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferErc721Celo.new
  end
  ...
  describe 'test an instance of TransferErc721Celo' do
    it 'should create an instance of TransferErc721Celo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferErc721Celo)
    end
  end
