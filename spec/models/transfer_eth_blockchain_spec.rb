...
# Unit tests for SwaggerClient::TransferEthBlockchain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferEthBlockchain' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferEthBlockchain.new
  end
  ...
  describe 'test an instance of TransferEthBlockchain' do
    it 'should create an instance of TransferEthBlockchain' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferEthBlockchain)
    end
  end
