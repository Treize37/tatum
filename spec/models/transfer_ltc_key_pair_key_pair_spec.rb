...
# Unit tests for SwaggerClient::TransferLtcKeyPairKeyPair
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferLtcKeyPairKeyPair' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferLtcKeyPairKeyPair.new
  end
  ...
  describe 'test an instance of TransferLtcKeyPairKeyPair' do
    it 'should create an instance of TransferLtcKeyPairKeyPair' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferLtcKeyPairKeyPair)
    end
  end
