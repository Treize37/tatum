...
# Unit tests for SwaggerClient::TransferMultiTokenBatchCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenBatchCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferMultiTokenBatchCelo.new
  end
  ...
  describe 'test an instance of TransferMultiTokenBatchCelo' do
    it 'should create an instance of TransferMultiTokenBatchCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferMultiTokenBatchCelo)
    end
  end
