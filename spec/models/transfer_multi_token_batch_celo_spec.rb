...
# Unit tests for Tatum::TransferMultiTokenBatchCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenBatchCelo' do
  before do
    # run before each test
    @instance = Tatum::TransferMultiTokenBatchCelo.new
  end
  ...
  describe 'test an instance of TransferMultiTokenBatchCelo' do
    it 'should create an instance of TransferMultiTokenBatchCelo' do
      expect(@instance).to be_instance_of(Tatum::TransferMultiTokenBatchCelo)
    end
  end
