...
# Unit tests for SwaggerClient::TransferMultiTokenBatchKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenBatchKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferMultiTokenBatchKMSCelo.new
  end
  ...
  describe 'test an instance of TransferMultiTokenBatchKMSCelo' do
    it 'should create an instance of TransferMultiTokenBatchKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferMultiTokenBatchKMSCelo)
    end
  end
