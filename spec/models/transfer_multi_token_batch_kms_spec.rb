...
# Unit tests for SwaggerClient::TransferMultiTokenBatchKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenBatchKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferMultiTokenBatchKMS.new
  end
  ...
  describe 'test an instance of TransferMultiTokenBatchKMS' do
    it 'should create an instance of TransferMultiTokenBatchKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferMultiTokenBatchKMS)
    end
  end
