...
# Unit tests for SwaggerClient::TransferMultiTokenCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferMultiTokenCelo.new
  end
  ...
  describe 'test an instance of TransferMultiTokenCelo' do
    it 'should create an instance of TransferMultiTokenCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferMultiTokenCelo)
    end
  end
