...
# Unit tests for Tatum::TransferMultiTokenKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenKMSCelo' do
  before do
    # run before each test
    @instance = Tatum::TransferMultiTokenKMSCelo.new
  end
  ...
  describe 'test an instance of TransferMultiTokenKMSCelo' do
    it 'should create an instance of TransferMultiTokenKMSCelo' do
      expect(@instance).to be_instance_of(Tatum::TransferMultiTokenKMSCelo)
    end
  end
