...
# Unit tests for SwaggerClient::TransferMultiTokenKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferMultiTokenKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferMultiTokenKMS.new
  end
  ...
  describe 'test an instance of TransferMultiTokenKMS' do
    it 'should create an instance of TransferMultiTokenKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferMultiTokenKMS)
    end
  end
