...
# Unit tests for SwaggerClient::TransferNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftCelo.new
  end
  ...
  describe 'test an instance of TransferNftCelo' do
    it 'should create an instance of TransferNftCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftCelo)
    end
  end
