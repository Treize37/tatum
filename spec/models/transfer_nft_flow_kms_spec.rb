...
# Unit tests for SwaggerClient::TransferNftFlowKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftFlowKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftFlowKMS.new
  end
  ...
  describe 'test an instance of TransferNftFlowKMS' do
    it 'should create an instance of TransferNftFlowKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftFlowKMS)
    end
  end
