...
# Unit tests for SwaggerClient::TransferNftKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftKMSCelo.new
  end
  ...
  describe 'test an instance of TransferNftKMSCelo' do
    it 'should create an instance of TransferNftKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftKMSCelo)
    end
  end
