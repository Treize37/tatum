...
# Unit tests for SwaggerClient::TransferNftKMSTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftKMSTron' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftKMSTron.new
  end
  ...
  describe 'test an instance of TransferNftKMSTron' do
    it 'should create an instance of TransferNftKMSTron' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftKMSTron)
    end
  end
