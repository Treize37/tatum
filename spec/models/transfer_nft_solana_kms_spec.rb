...
# Unit tests for SwaggerClient::TransferNftSolanaKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftSolanaKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftSolanaKMS.new
  end
  ...
  describe 'test an instance of TransferNftSolanaKMS' do
    it 'should create an instance of TransferNftSolanaKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftSolanaKMS)
    end
  end
