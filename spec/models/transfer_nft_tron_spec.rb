...
# Unit tests for SwaggerClient::TransferNftTron
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferNftTron' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferNftTron.new
  end
  ...
  describe 'test an instance of TransferNftTron' do
    it 'should create an instance of TransferNftTron' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferNftTron)
    end
  end
