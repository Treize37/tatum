...
# Unit tests for SwaggerClient::TransferTronTrc10Blockchain
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransferTronTrc10Blockchain' do
  before do
    # run before each test
    @instance = SwaggerClient::TransferTronTrc10Blockchain.new
  end
  ...
  describe 'test an instance of TransferTronTrc10Blockchain' do
    it 'should create an instance of TransferTronTrc10Blockchain' do
      expect(@instance).to be_instance_of(SwaggerClient::TransferTronTrc10Blockchain)
    end
  end
