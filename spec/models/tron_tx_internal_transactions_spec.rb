...
# Unit tests for SwaggerClient::TronTxInternalTransactions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TronTxInternalTransactions' do
  before do
    # run before each test
    @instance = SwaggerClient::TronTxInternalTransactions.new
  end
  ...
  describe 'test an instance of TronTxInternalTransactions' do
    it 'should create an instance of TronTxInternalTransactions' do
      expect(@instance).to be_instance_of(SwaggerClient::TronTxInternalTransactions)
    end
  end
