...
# Unit tests for SwaggerClient::UpdateCashbackValueForAuthorNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCashbackValueForAuthorNftCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateCashbackValueForAuthorNftCelo.new
  end
  ...
  describe 'test an instance of UpdateCashbackValueForAuthorNftCelo' do
    it 'should create an instance of UpdateCashbackValueForAuthorNftCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateCashbackValueForAuthorNftCelo)
    end
  end
