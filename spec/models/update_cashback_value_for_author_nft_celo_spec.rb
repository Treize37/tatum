...
# Unit tests for Tatum::UpdateCashbackValueForAuthorNftCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCashbackValueForAuthorNftCelo' do
  before do
    # run before each test
    @instance = Tatum::UpdateCashbackValueForAuthorNftCelo.new
  end
  ...
  describe 'test an instance of UpdateCashbackValueForAuthorNftCelo' do
    it 'should create an instance of UpdateCashbackValueForAuthorNftCelo' do
      expect(@instance).to be_instance_of(Tatum::UpdateCashbackValueForAuthorNftCelo)
    end
  end
