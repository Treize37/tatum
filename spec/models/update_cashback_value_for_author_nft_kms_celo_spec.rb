...
# Unit tests for SwaggerClient::UpdateCashbackValueForAuthorNftKMSCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCashbackValueForAuthorNftKMSCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateCashbackValueForAuthorNftKMSCelo.new
  end
  ...
  describe 'test an instance of UpdateCashbackValueForAuthorNftKMSCelo' do
    it 'should create an instance of UpdateCashbackValueForAuthorNftKMSCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateCashbackValueForAuthorNftKMSCelo)
    end
  end
