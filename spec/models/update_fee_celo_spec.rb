...
# Unit tests for SwaggerClient::UpdateFeeCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateFeeCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateFeeCelo.new
  end
  ...
  describe 'test an instance of UpdateFeeCelo' do
    it 'should create an instance of UpdateFeeCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateFeeCelo)
    end
  end
