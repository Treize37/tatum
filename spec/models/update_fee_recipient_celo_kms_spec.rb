...
# Unit tests for SwaggerClient::UpdateFeeRecipientCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateFeeRecipientCeloKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateFeeRecipientCeloKMS.new
  end
  ...
  describe 'test an instance of UpdateFeeRecipientCeloKMS' do
    it 'should create an instance of UpdateFeeRecipientCeloKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateFeeRecipientCeloKMS)
    end
  end
