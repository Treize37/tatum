...
# Unit tests for Tatum::UpdateFeeRecipientCeloKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateFeeRecipientCeloKMS' do
  before do
    # run before each test
    @instance = Tatum::UpdateFeeRecipientCeloKMS.new
  end
  ...
  describe 'test an instance of UpdateFeeRecipientCeloKMS' do
    it 'should create an instance of UpdateFeeRecipientCeloKMS' do
      expect(@instance).to be_instance_of(Tatum::UpdateFeeRecipientCeloKMS)
    end
  end
