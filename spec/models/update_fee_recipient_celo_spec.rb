...
# Unit tests for SwaggerClient::UpdateFeeRecipientCelo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateFeeRecipientCelo' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateFeeRecipientCelo.new
  end
  ...
  describe 'test an instance of UpdateFeeRecipientCelo' do
    it 'should create an instance of UpdateFeeRecipientCelo' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateFeeRecipientCelo)
    end
  end
