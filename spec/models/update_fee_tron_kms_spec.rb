...
# Unit tests for SwaggerClient::UpdateFeeTronKMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateFeeTronKMS' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateFeeTronKMS.new
  end
  ...
  describe 'test an instance of UpdateFeeTronKMS' do
    it 'should create an instance of UpdateFeeTronKMS' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateFeeTronKMS)
    end
  end
