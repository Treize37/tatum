...
# Unit tests for SwaggerClient::VC
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VC' do
  before do
    # run before each test
    @instance = SwaggerClient::VC.new
  end
  ...
  describe 'test an instance of VC' do
    it 'should create an instance of VC' do
      expect(@instance).to be_instance_of(SwaggerClient::VC)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ETH", "XRP", "XLM"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "initial_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
