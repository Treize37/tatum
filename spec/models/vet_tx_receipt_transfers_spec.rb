...
# Unit tests for SwaggerClient::VetTxReceiptTransfers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VetTxReceiptTransfers' do
  before do
    # run before each test
    @instance = SwaggerClient::VetTxReceiptTransfers.new
  end
  ...
  describe 'test an instance of VetTxReceiptTransfers' do
    it 'should create an instance of VetTxReceiptTransfers' do
      expect(@instance).to be_instance_of(SwaggerClient::VetTxReceiptTransfers)
    end
  end
