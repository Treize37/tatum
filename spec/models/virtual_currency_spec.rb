...
# Unit tests for SwaggerClient::VirtualCurrency
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VirtualCurrency' do
  before do
    # run before each test
    @instance = SwaggerClient::VirtualCurrency.new
  end
  ...
  describe 'test an instance of VirtualCurrency' do
    it 'should create an instance of VirtualCurrency' do
      expect(@instance).to be_instance_of(SwaggerClient::VirtualCurrency)
    end
  end
