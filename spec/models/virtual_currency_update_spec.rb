...
# Unit tests for SwaggerClient::VirtualCurrencyUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VirtualCurrencyUpdate' do
  before do
    # run before each test
    @instance = SwaggerClient::VirtualCurrencyUpdate.new
  end
  ...
  describe 'test an instance of VirtualCurrencyUpdate' do
    it 'should create an instance of VirtualCurrencyUpdate' do
      expect(@instance).to be_instance_of(SwaggerClient::VirtualCurrencyUpdate)
    end
  end
