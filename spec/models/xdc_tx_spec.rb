...
# Unit tests for SwaggerClient::XdcTx
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XdcTx' do
  before do
    # run before each test
    @instance = SwaggerClient::XdcTx.new
  end
  ...
  describe 'test an instance of XdcTx' do
    it 'should create an instance of XdcTx' do
      expect(@instance).to be_instance_of(SwaggerClient::XdcTx)
    end
  end
