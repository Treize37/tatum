...
# Unit tests for SwaggerClient::XrpAccountBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XrpAccountBalance' do
  before do
    # run before each test
    @instance = SwaggerClient::XrpAccountBalance.new
  end
  ...
  describe 'test an instance of XrpAccountBalance' do
    it 'should create an instance of XrpAccountBalance' do
      expect(@instance).to be_instance_of(SwaggerClient::XrpAccountBalance)
    end
  end
